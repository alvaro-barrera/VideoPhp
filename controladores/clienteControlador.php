                            ...
                            if ($guardarCuenta->rowCount()>=1) {
                                ...
                                if ($guardarCliente->rowCount()>=1) {
                                    $alerta=[
                                        ...
                                        "Texto"=>"Se realizo con éxtio el registro del cliente en el sistema",
                                        "Tipo"=>"success"
                                    ];
                                } else {
                                    ...
                                    $alerta=[
                                        "Alerta"=>"simple",
                                        "Titulo"=>"Ocurrió un error inesperado",
                                        "Texto"=>"No hemos podido registrar al cliente encuentra registrado en el sistema, intente nuevamente",
                                        "Tipo"=>"error"
                                    ];
                                }
        ...
        public function eliminar_cliente_controlador(){
            ...
            if ($privilegio==1) {
                ...
                if ($DelClient->rowCount()>=1) {
                    ...
                    if ($DelCuenta->rowCount()>=1) {
                        $alerta=[
                            ...
                            "Texto"=>"El cliente fue eliminado del sistema",
                            "Tipo"=>"success"
                        ];
                    } else {
                        $alerta=[
                            "Alerta"=>"simple",
                            "Titulo"=>"Ocurrió un error inesperado",
                            "Texto"=>"No podemos eliminar al cliente en este momento",
                            "Tipo"=>"error"
                        ];
                    }
                ...
                $alerta=[
                    "Alerta"=>"simple",
                    "Titulo"=>"Ocurrió un error inesperado",
                    "Texto"=>"No tiene los permisos necesarios para realizar la operación",
                    "Tipo"=>"error"
                ];
            }
            return mainModel::sweet_alert($alerta);
        ...
        public function actualizar_cliente_controlador(){
           ...
           if (clienteModelo::actualizar_cliente_modelo($dataClient)) {
            $alerta=[
                "Alerta"=>"recargar",
                "Titulo"=>"Operación exitosa",
                "Texto"=>"Los datos del cliente se actualizaron de forma correcta",
                "Tipo"=>"success"
            ];
           } else {
            $alerta=[
