		    				...
		    				<div class="col-xs-12">
								<div class="form-group">
									...
									<div class="radio radio-primary">
										<label>
											<input type="radio" name="optionsGenero" id="optionsRadios1" value="Masculino" checked=""><span class="circle"></span><span class="check"></span>
											<i class="zmdi zmdi-male-alt"></i> &nbsp; Masculino
										</label>
									</div>
									<div class="radio radio-primary">
										<label>
											<input type="radio" name="optionsGenero" id="optionsRadios2" value="Femenino"><span class="circle"></span><span class="check"></span>
		    	...
		    	<fieldset>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
							...
							<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" id="optionsRadios1" value="<?php echo $lc->encryption(1);?>"><span class="circle"></span><span class="check"></span>
							...
							?>
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" id="optionsRadios2"  value="<?php echo $lc->encryption(2);?>"><span class="circle"></span><span class="check"></span>
							...
							?>
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio" id="optionsRadios3"  value="<?php echo $lc->encryption(3);?>" checked=""><span class="circle"></span><span class="check"></span>
