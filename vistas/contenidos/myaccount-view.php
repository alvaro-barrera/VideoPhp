	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<fieldset>
				...
				<br>
				<?php if ($_SESSION['tipo_sbp'] =="Administrador" && $_SESSION['privilegio_sbp']==1 && $campos['id']!=1 && $campos['CuentaTipo']=="Administrador" && $campos['']) { ?>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
		    				...
		    				<div class="col-xs-12 col-sm-6">
								...
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(1);?>" <?php if ($campos['CuentaPrivilegio']==2) {echo 'checked=""' ;}?>>
										<i class="zmdi zmdi-star"></i> &nbsp; Nivel 2
									</label>
								</div>
								<div class="radio radio-primary">
									<label>
										<input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(1);?>" <?php if ($campos['CuentaPrivilegio']==3) {echo 'checked=""' ;}?>>
